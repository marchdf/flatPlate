...
if __name__ == "__main__":
    ...
    plt.figure(0)
    p = plt.plot(df["retheta"], df["cf"], lw=2, color=cmap[0], label="K-S theory")
    ...
    plt.figure(1)
    p = plt.plot(df["log10yp"], df["up"], lw=2, color=cmap[0], label="Coles theory")
    p[0].set_dashes(dashseq[0])
    ...
    plt.figure(0)
    p = plt.plot(df["retheta"], df["cf"], lw=2, color=cmap[1], label="NASA CFL3D")
    ...
    plt.figure(1)
    p = plt.plot(df["log10yp"], df["up"], lw=2, color=cmap[1], label="NASA CFL3D")
    p[0].set_dashes(dashseq[1])
    ...
    plt.figure(0)
    p = plt.plot(df["retheta"], df["cf"], lw=2, color=cmap[2], label="Nalu")
    ...
    plt.figure(1)
    p = plt.plot(df["log10yp"], df["up"], lw=2, color=cmap[2], label="Nalu")
    p[0].set_dashes(dashseq[2])
